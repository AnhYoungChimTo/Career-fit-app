 ...
 */
export async function getLiteQuestions(_req: Request, res: Response) {
  try {
 ...
 */
export async function getDeepModulesMetadata(_req: Request, res: Response) {
  try {
 ...
 */
export async function getDeepModule(req: Request, res: Response) {
  try {
...
export async function updatePosition(req: Request, res: Response) {
  try {
    ...
    const interview = await interviewService.updateInterviewPosition(
      id,
      currentModule,
      currentQuestion
    );
 ...
 */
export async function getInterviewModules(req: Request, res: Response) {
  try {
    const id = String(req.params.id);
 ...
 */
export async function upgradeInterview(req: Request, res: Response) {
  try {
    const id = String(req.params.id);
 ...
 */
export async function abandonInterview(req: Request, res: Response) {
  try {
    const id = String(req.params.id);
