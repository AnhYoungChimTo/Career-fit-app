...
router.get('/:id/modules', auth_middleware_1.authMiddleware, interviewController.getInterviewModules);
...
router.post('/:id/upgrade', auth_middleware_1.authMiddleware, interviewController.upgradeInterview);
router.delete('/:id/abandon', auth_middleware_1.authMiddleware, interviewController.abandonInterview);
