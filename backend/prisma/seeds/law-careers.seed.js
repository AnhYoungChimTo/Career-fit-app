...
exports.lawCareers = void 0;
exports.seedLawCareers = seedLawCareers;
...
const lawCareers = [
    ...
    },
    {
        ...
        description: 'Senior lawyer at Vietnamese firm (5-8 years PQE). Leads transactions independently, manages junior associates, develops client relationships, and specializes in key practice areas. Top practice areas in Vietnam (2026): Corporate/M&A, Banking & Finance, Real Estate, Data Privacy & Compliance, Projects & Infrastructure. Country: Vietnam. Typical firms: VILAF, YKVN, Rajah & Tann LCT. Senior associates at Tier 1 firms earn significantly more.',
        requirements: {
            a1: {
                openness: 70,
                conscientiousness: 90,
    ...
    },
    {
        ...
        description: 'Advises banks, financial institutions, and borrowers on lending, structured finance, project finance, and capital markets in Vietnam. Drafts loan agreements, security documents, and regulatory filings. Works with SBV (State Bank of Vietnam) regulations and SSC (State Securities Commission) requirements. Country: Vietnam. Firms: Baker McKenzie, Freshfields, VILAF, Rajah & Tann LCT. Growing demand from infrastructure projects and green finance.',
        requirements: {
            a1: {
                openness: 65,
                conscientiousness: 95,
    ...
    },
    {
        ...
        description: 'Advises on real estate transactions, construction projects, land use rights, and property development in Vietnam. Handles due diligence on land titles, drafts sale/lease agreements, advises on foreign ownership restrictions, and navigates complex land law. Country: Vietnam. Firms: Hogan Lovells (strong real estate practice), VILAF, Rajah & Tann LCT, Baker McKenzie. Key laws: Land Law 2024 (effective Jan 2025), Housing Law, Real Estate Business Law.',
        requirements: {
            a1: {
                openness: 60,
                conscientiousness: 90,
    ...
    },
    {
        ...
        description: 'Leads the legal department of a Vietnamese company or MNC Vietnam subsidiary (10-15 years PQE). Manages legal team (3-10 lawyers), sets legal strategy, manages external law firm relationships, advises C-suite on risk and governance. Reports to General Counsel or CEO. Country: Vietnam. Typical employers: Major Vietnamese corporations, regional MNC headquarters, mid-size international companies in Vietnam.',
        requirements: {
            a1: {
                openness: 68,
                conscientiousness: 90,
    ...
    },
    {
        ...
        description: 'Ensures company compliance with Vietnamese laws, regulations, and internal policies. Develops compliance programs, conducts risk assessments, trains staff, and investigates potential violations. Growing demand in banking, fintech, and MNCs. Country: Vietnam. Typical employers: Banks (Vietcombank, Techcombank, HSBC Vietnam), fintech companies, pharmaceutical firms, manufacturing MNCs. Key regulations: AML/CFT laws, data protection, anti-corruption.',
        requirements: {
            a1: {
                openness: 58,
                conscientiousness: 92,
    ...
    },
    {
        ...
        description: 'Leads compliance function for major Vietnamese company or MNC Vietnam operations (8-15 years experience). Designs enterprise-wide compliance frameworks, manages regulatory relationships, oversees internal investigations, and reports to Board/Audit Committee. Country: Vietnam. Typical employers: Major banks, insurance companies, listed corporations, international MNCs. Reports to CEO or General Counsel.',
        requirements: {
            a1: {
                openness: 62,
                conscientiousness: 95,
    ...
    // ==========================================
    {
        ...
        description: 'Entry-level position in Vietnamese government legal departments (People\'s Courts, People\'s Procuracy, Ministry of Justice). Assists with case file management, legal research, document preparation, and administrative tasks. Country: Vietnam. Employers: People\'s Courts (Tòa án Nhân dân), People\'s Procuracy (Viện Kiểm sát Nhân dân), Ministry of Justice (Bộ Tư pháp). Requirements: Vietnamese LLB, pass civil service exam. Salary follows government pay scale (Decree 204/2004/NĐ-CP, updated).',
        requirements: {
            a1: {
                openness: 50,
                conscientiousness: 85,
    ...
    },
    {
        ...
        description: 'Fourth through fifth year associate taking on greater responsibility and client interaction. Manages discrete workstreams, supervises juniors, drafts complex agreements, and begins developing subject matter expertise. Country: United States. Base salary (Cravath scale): 4th year $310,000, 5th year $345,000 + bonus $50,000-$80,000. This is the critical period for partnership trajectory assessment. Firms: Same as junior associate + lateral movement between firms common at this level.',
        requirements: {
            a1: {
                openness: 72,
                conscientiousness: 92,
    ...
    },
    {
        ...
        description: 'Non-equity/senior position between associate and partner at US Big Law firms. Experienced attorneys who may not be on partnership track but provide valuable expertise. Often specialists in niche practice areas. Country: United States. Typical firms: All major US firms have counsel positions. Compensation: $400,000-$600,000+ base. For Vietnamese-qualified lawyers: very rare, usually requires 10+ years US experience.',
        requirements: {
            a1: {
                openness: 68,
                conscientiousness: 90,
    ...
    },
    {
        ...
        description: 'Senior associate at a Magic Circle firm (4-7 years PQE). Manages complex cross-border transactions, supervises junior associates and trainees, develops client relationships, and begins building a reputation in their practice area. Country: United Kingdom (London). Salary: £140,000-£240,000+ depending on firm and PQE (Roll On Friday / Legal Cheek 2025). Firms: Freshfields (associates earning up to ~£240,000 at top of scale), A&O Shearman, Clifford Chance, Linklaters.',
        requirements: {
            a1: {
                openness: 72,
                conscientiousness: 92,
    ...
    // ==========================================
    {
        ...
        description: 'Specializes in trademark registration, patent prosecution, copyright protection, and IP enforcement in Vietnam. Advises both domestic and international clients on IP portfolio management. Growing demand as Vietnam strengthens IP protection under CPTPP and EVFTA commitments. Country: Vietnam. Firms: Baker McKenzie (strong IP practice), Hogan Lovells, VILAF, Pham & Associates (IP boutique), Tilleke & Gibbins. Also: NOIP (National Office of Intellectual Property) filings.',
        requirements: {
            a1: {
                openness: 68,
                conscientiousness: 90,
    ...
    },
    {
        ...
        description: 'Bridges law and technology by implementing legal tech solutions (contract management, e-discovery, AI-assisted legal research, document automation). Works in law firms, legal departments, or legal tech startups. Country: Vietnam / International. Employers: Legal tech companies (LegalForce, Luminance), Big Law innovation teams, corporate legal operations teams. Growing field globally with Vietnam emerging as a legal tech hub for SE Asia.',
        requirements: {
            a1: {
                openness: 85,
                conscientiousness: 82,
